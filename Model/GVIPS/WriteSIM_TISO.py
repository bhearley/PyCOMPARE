...
def WriteSIM_TISO(self, TestData, temp_dir, ct_file, mod, Param, P_Elas):
    # Import Modules
    import os
    import numpy as np
    ...
    if TestData['Angle'] > 0:
        ...
        ang = '%.8E' % Decimal(str(TestData['Angle']))
    file.write(' MODL=' + str(mod) + ' BET=' + ang + '\n')

    # Write *ELAS
    file.write('*ELAS\n')
    file.write(' E1= ' + str(P_Elas[0]) + ' E2= ' + str(P_Elas[1]) + ' &\n')
    file.write(' NU12= ' + str(P_Elas[2]) + ' G12= ' + str(P_Elas[3])  + '\n')
