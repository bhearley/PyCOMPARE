...
def PyCOMPARE():
    ...
    # Import Functions
    from Data.CreateCharacterizationTab import CreateCharacterizationTab
    from Data.CreateDataTab import CreateDataTab
    from General.BuildGeneralPage import BuildGeneralPage
    from General.CreateExportTab import CreateExportTab
    from General.CreateSettingsTab import CreateSettingsTab
    from General.GetProjectFile import CreateNewProject, LoadProject
    from GUI.Placements import Placements
    from GUI.GetStyles import GetStyles
    from Model.CreateAnalysisTab import CreateAnalysisTab
    from Model.CreateModelTab import CreateModelTab
    from Model.GVIPS.WriteDSG_GVIPS_ISO_ANLY import WriteDSG_GVIPS_ISO_ANLY
    from Model.GVIPS.WriteDSG_GVIPS_TISO_ANLY import WriteDSG_GVIPS_TISO_ANLY
    from Model.GVIPS.WriteDSG_GVIPS_ISO_OPT import WriteDSG_GVIPS_ISO_OPT
    from Model.GVIPS.WriteDSG_GVIPS_TISO_OPT import WriteDSG_GVIPS_TISO_OPT
    from Model.GVIPS.WriteNLP import WriteNLP
    from Model.GVIPS.WriteSIM_ISO import WriteSIM_ISO
    from Model.GVIPS.WriteSIM_TISO import WriteSIM_TISO
    ...
    from Visualization.CreateVisualizationTab import CreateVisualizationTab
